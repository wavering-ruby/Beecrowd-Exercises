...
class Folder:
    ...
    def get_folder_structure(self, base_path, script_dir, extensions=None):
        """
        ...
        for folder in folders:
            ...
            folder_data.append({
                "folderName": folder,
                "folderFiles": self.get_folder_files(folder_path, extensions[0])  # Assumindo que getFolderFiles existe
            })
    ...
    def get_folder_structure(self, base_path, script_dir, extensions=None):
        ...
        for folder in folders:
            ...
            folder_data.append({
                "folderName": folder,
                "folderFiles": self.get_folder_files(folder_path, extensions[0])  # Assume que get_folder_files existe
            })
